...
#Stan definitions       #Partly copied from Victor Sandells implementation
stan_model = """
...
parameters {
    real mu;                    // Group mean
    real<lower=0> tau;          //of the individual thetas
...
fit = compiled_model.sampling(data=stan_data,iter=21000,warmup=1000, chains=1)
